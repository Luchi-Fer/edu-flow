...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Nuevo preceptor', href: PreceptorController.create() },
        ],
    },
});
</script>
...
<template>
    <Head title="Nuevo preceptor" />

    <div class="flex flex-col space-y-6 p-4">
        <Heading
            title="Nuevo preceptor"
            description="Cargar los datos del preceptor y su cuenta de acceso"
        />

        <Form
            v-bind="PreceptorController.store.form()"
